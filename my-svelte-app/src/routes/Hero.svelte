        ...
        <div class="mx-auto py-12 flex flex-col md:flex-row items-center gap-8">
            <div class="text-left flex-2">
                ...
                <div class="mt-10 flex items-center gap-x-6">
                    <a href="https://buy.stripe.com/fZecNOcbwfFLfD2fYY" class="stripe-link rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
                    <a href="#jessie" class="text-sm font-semibold leading-6 text-gray-900">Learn more<span aria-hidden="true">→</span></a> 
                </div>
            </div>
            <div class="flex-1 w-full">
                <img src="/chat_mockup.png" alt="Chat Mockup" class="w-full h-auto">
            </div>
        </div>
