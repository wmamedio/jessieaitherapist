...
<section class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-lg text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600">We are here to help and answer any questions you might have. Reach out to us for more information, support, or feedback.</p>
    </div>
    ...
    <div class="mt-16 text-center">
        <!-- <p class="text-lg text-gray-600">Email: <a href="mailto:support@jessietherapist.com" class="text-indigo-600 hover:text-indigo-500">support@jessietherapist.com</a></p>
        <p class="text-lg text-gray-600">Phone: <a href="tel:+1234567890" class="text-indigo-600 hover:text-indigo-500">+1 (234) 567-890</a></p> -->
