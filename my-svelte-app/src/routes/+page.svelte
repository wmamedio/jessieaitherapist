    ...
    onMount(() => {
        ...
        if (urlParams.get('mode') === 'test') {
            ...
            for (let i = 0; i < links.length; i++) {
                links[i].href = 'https://buy.stripe.com/test_9AQ7wg3XS2xG6Iw3ce';
            }
        }
    });
...
<div class="bg-white">
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="https://buy.stripe.com/14keXA401fEwaGc5km" class="stripe-link text-sm font-semibold leading-6 text-gray-900">
    ...
    <div class="lg:hidden fixed inset-0 z-50">
        ...
        <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
                ...
                <div class="py-6">
                    <a
                    href="https://buy.stripe.com/14keXA401fEwaGc5km"
